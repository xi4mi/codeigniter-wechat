...
class Meta_Ajax_Log extends Meta_Log {
...
class Log_ajax_saver extends Log_saver{
	...
	const LOG_PATH = '/data/logs/platform/'; //web服务器（或者是nfs）上面的log路径
	
	public function save($obj_log, $platform){
		$filename = $this->get_file_name(self::LOG_PATH . $platform . '/ajax_' . date('Ymd') . '.log');
